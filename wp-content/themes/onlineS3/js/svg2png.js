...
var exportSvg2PNG = function(args) {
    ...
    try {
        ...
        canvas.width = Number(svg.getAttribute("width")) + 20;   // set canvas dimensions
...
function clearBlack(container) {
    var nodeList = container.querySelectorAll('axis path');
    var nodeList2 = container.querySelectorAll('path');
    var nodeList3 = container.querySelectorAll('line');
    var border = container.querySelectorAll('.border');
    
    var paths = Array.from(nodeList);
...
//    
//    // corrects y axis
//    var y_axis = Array.from(container.querySelectorAll('.axis'));
//    y_axis.forEach(function(element){
//        element.style.color = "red";
//    });
//    
//    var y_axis_text = Array.from(container.querySelectorAll('.axis text'));
//    y_axis_text.forEach(function(element){
//        element.style.fill = "rgb(109, 109, 109)";
